...
class ProjectRepository {
  ...
  private initializeProjects(): void {
    const humanoiaProject = new Project(
      ...
      "HTML • CSS • JavaScript",
      "/public/humanoia-preview.png",
      ["/public/humanoia-1.png", "/public/humanoia-2.png", "/public/humanoia-3.png"],
      {
    ...
    const formulaFacilProject = new Project(
      ...
      "/public/formulafacil.png",
      ["/public/formulafacil.png", "/public/formulafacil2.png"],
      {
        es: [
